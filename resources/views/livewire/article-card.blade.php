<a href="" class="h-96 w-full cursor-pointer flex flex-col items-center rounded-lg shadow md:flex-row md:max-w-xl ">
    <img class="ml-2 object-cover w-full md:h-auto md:w-48"
