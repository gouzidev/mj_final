...
<link href="https://fonts.googleapis.com/css2?family=Playfair+Display&family=Unbounded&display=swap" rel="stylesheet">




<div class="nav py-4 mb-2 max-w-screen-xl" id="navigation">

        <div  class=" md:fixed  w-screen top-0 md:z-[100] ">
                <div id="spec_nav" class="max-w-screen-xl duration-200 sticky flex flex-wrap justify-between items-center mx-auto md:px-6 px-4 py-3 bg-white rounded-lg mt-4">
                    <a href="/" class="flex flex-col md:flex-row items-center w-full md:auto md:w-1/4 ">
                        <img src={{asset("logo.png")}} class="h-14 md:mr-2" alt="La Ministère de la Justice" />
                        <div class="">
                            <h4 href="#" class="text-sm font-medium uppercase gold">Royaume du Maroc</h4>
                            <h5 href="#" class="text-sm md:font-small uppercase hidden md:flex font_playfaire">La Ministère de la Justice</h5>    
                        </div>
                     </a>
                     <div class="flex items-center justify-center md:justify-left w-full md:w-auto ">
                        <p class=" flex " id='title'>

                        </p>

                    </div> 
                    <div class="hidden md:flex justify-end md:w-1/4">
                        <img src={{asset("centre-logo.png")}} class="h-16" alt="La Ministère de la Justice" />
                </div>      
            </div>
...
<script src="https://kit.fontawesome.com/ba496a122f.js" crossorigin="anonymous"></script>
